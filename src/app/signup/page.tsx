...
function SignUpBox() {
  return (
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 w-[424px] h-[564px] relative">
        {/* Sign up Heading */}
        <h2 className="text-2xl text-[20px] text-gray-800 text-start mb-6">Sign Up</h2>
        ...
        <form className="flex flex-col space-y-4">
          ...
          {/* Email Input */}
          <div className="flex items-center border border-gray-300 rounded-md shadow-sm focus:ring-custom-yellow focus:border-custom-yellow ">
          ...
          <div className="flex items-center">
            <input
              id="remember-me"
              type="checkbox"
              className="h-4 w-4 text-custom-yellow bg-custom-yellow focus:ring-custom-yellow focus:border-custom-yellow" />
          ...
          <button
            type="submit"
            className="w-full bg-custom-yellow text-white py-2 px-4 rounded-md hover:bg-orange-600 transition-all relative"
          >
            Sign Up
          </button>
        ...
        <div className="space-y-3">
          ...
          >
            <Image src={'/images/appleimage.png'} height={26}
              width={26} alt=' logo' />           <p> Sign Up with Apple</p>
          </button>
        </div>
      </div>
    </div></>
